## filter out confound global noise and save in seperate directory
import os, csv
import numpy as np
import scipy as sp
...
for sub_index in range(0, len(all_subjects)):
	...
	sub_out_dir = sub_dir + sub + '_global/'
	...
	for run in range(1, total_run + 1):		
		...
		out_file = sub_out_dir + sub + '_run_' + str(run) + '_global.npy'
