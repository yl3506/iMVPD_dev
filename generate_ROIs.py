...
all_subjects = ['sub-19']
all_masks = ['TPmask_R_funcSize_bin.nii.gz', 'ROI_rFFA_kanparcel_xyz_warped_funcSize.nii.gz', 'ROI_rOFA_kanparcel_xyz_warped_funcSize.nii.gz', 'wholeROI_rSTS_kanparcel_warped_funcSize.nii.gz']
mask_label = 0
#all_masks_dir = ''
...
for subject in all_subjects: # iterate through all subjects
	...
	for mask in all_masks: # iterate 4 kinds of masks
		# data initialization
