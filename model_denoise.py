...
### main_out_dir = '/Users/chloe/Documents/output_denoise_normalized/'
...
for sub_1_index in range(0, len(all_subjects) - 1):
	for sub_2_index in range(sub_1_index + 1, len(all_subjects)):
		...
		for direction_index in range(0, 2): 
			...
			sub_1_data_dir = work_dir + sub_1 + '_complete/' + sub_1 + '_denoised_normalized/' 
			sub_2_data_dir = work_dir + sub_2 + '_complete/' + sub_2 + '_denoised_normalized/' 
